...
template<> FARMER_API UScriptStruct* StaticStruct<FSoilData>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bIsFruit_MetaData[];
#endif
		static void NewProp_bIsFruit_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bIsFruit;
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSoilData_Statics::NewProp_bIsPlanted_MetaData[] = {
		{ "Category", "SoilData" },
		{ "ModuleRelativePath", "Public/MySaveGame.h" },
	};
#endif
	void Z_Construct_UScriptStruct_FSoilData_Statics::NewProp_bIsPlanted_SetBit(void* Obj)
	{
		((FSoilData*)Obj)->bIsPlanted = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSoilData_Statics::NewProp_bIsPlanted = { "bIsPlanted", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FSoilData), &Z_Construct_UScriptStruct_FSoilData_Statics::NewProp_bIsPlanted_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSoilData_Statics::NewProp_bIsPlanted_MetaData), Z_Construct_UScriptStruct_FSoilData_Statics::NewProp_bIsPlanted_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSoilData_Statics::NewProp_bIsFruit_MetaData[] = {
		{ "Category", "SoilData" },
		{ "ModuleRelativePath", "Public/MySaveGame.h" },
	};
#endif
	void Z_Construct_UScriptStruct_FSoilData_Statics::NewProp_bIsFruit_SetBit(void* Obj)
	{
		((FSoilData*)Obj)->bIsFruit = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSoilData_Statics::NewProp_bIsFruit = { "bIsFruit", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FSoilData), &Z_Construct_UScriptStruct_FSoilData_Statics::NewProp_bIsFruit_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSoilData_Statics::NewProp_bIsFruit_MetaData), Z_Construct_UScriptStruct_FSoilData_Statics::NewProp_bIsFruit_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FSoilData_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSoilData_Statics::NewProp_bIsPlanted,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSoilData_Statics::NewProp_bIsFruit,
...
template<> FARMER_API UScriptStruct* StaticStruct<FPlant>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_cheng_source_repos_UE5_Farmer_Source_Farmer_Public_MySaveGame_h_Statics::ScriptStructInfo[] = {
		{ FSoilData::StaticStruct, Z_Construct_UScriptStruct_FSoilData_Statics::NewStructOps, TEXT("SoilData"), &Z_Registration_Info_UScriptStruct_SoilData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSoilData), 997698908U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_cheng_source_repos_UE5_Farmer_Source_Farmer_Public_MySaveGame_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMySaveGame, UMySaveGame::StaticClass, TEXT("UMySaveGame"), &Z_Registration_Info_UClass_UMySaveGame, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMySaveGame), 1728225624U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_cheng_source_repos_UE5_Farmer_Source_Farmer_Public_MySaveGame_h_1233653882(TEXT("/Script/Farmer"),
