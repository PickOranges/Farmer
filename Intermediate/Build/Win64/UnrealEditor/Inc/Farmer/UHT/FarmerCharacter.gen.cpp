...
// End Cross Module References
	DEFINE_FUNCTION(AFarmerCharacter::execUseItem)
	{
		P_GET_OBJECT(UFakeItem,Z_Param_Item);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(AFarmerCharacter::execPlayChoppingAnim)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->PlayChoppingAnim_Implementation();
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(AFarmerCharacter::execPressE)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->PressE_Implementation(Z_Param_Out_Value);
		P_NATIVE_END;
	}
	...
	static FName NAME_AFarmerCharacter_PlayChoppingAnim = FName(TEXT("PlayChoppingAnim"));
	void AFarmerCharacter::PlayChoppingAnim()
	{
		ProcessEvent(FindFunctionChecked(NAME_AFarmerCharacter_PlayChoppingAnim),NULL);
	}
	static FName NAME_AFarmerCharacter_PressE = FName(TEXT("PressE"));
	void AFarmerCharacter::PressE(FInputActionValue const& Value)
	{
	...
	void AFarmerCharacter::StaticRegisterNativesAFarmerCharacter()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "UseItem", &AFarmerCharacter::execUseItem },
		};
	...
	struct Z_Construct_UFunction_AFarmerCharacter_PressE_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFarmerCharacter_PressE_Statics::NewProp_Value_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AFarmerCharacter_PressE_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FarmerCharacter_eventPressE_Parms, Value), Z_Construct_UScriptStruct_FInputActionValue, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AFarmerCharacter_PressE_Statics::NewProp_Value_MetaData), Z_Construct_UFunction_AFarmerCharacter_PressE_Statics::NewProp_Value_MetaData) }; // 1693336646
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFarmerCharacter_PressE_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFarmerCharacter_PressE_Statics::NewProp_Value,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFarmerCharacter_PressE_Statics::Function_MetaDataParams[] = {
		{ "Category", "FarmerCharacter" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// CB for for pressing E\n" },
#endif
		{ "ModuleRelativePath", "FarmerCharacter.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "CB for for pressing E" },
#endif
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AFarmerCharacter_PressE_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFarmerCharacter, nullptr, "PressE", nullptr, nullptr, Z_Construct_UFunction_AFarmerCharacter_PressE_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AFarmerCharacter_PressE_Statics::PropPointers), sizeof(FarmerCharacter_eventPressE_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C480C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AFarmerCharacter_PressE_Statics::Function_MetaDataParams), Z_Construct_UFunction_AFarmerCharacter_PressE_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AFarmerCharacter_PressE_Statics::PropPointers) < 2048);
	static_assert(sizeof(FarmerCharacter_eventPressE_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AFarmerCharacter_PressE()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AFarmerCharacter_PressE_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics
	{
		struct FarmerCharacter_eventUseItem_Parms
		{
			UFakeItem* Item;
		};
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::NewProp_Item_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::NewProp_Item = { "Item", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FarmerCharacter_eventUseItem_Parms, Item), Z_Construct_UClass_UFakeItem_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::NewProp_Item_MetaData), Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::NewProp_Item_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::NewProp_Item,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::Function_MetaDataParams[] = {
		{ "Category", "FarmerCharacter" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//void UseItem(class UItem* Item);\n" },
#endif
		{ "ModuleRelativePath", "FarmerCharacter.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "void UseItem(class UItem* Item);" },
#endif
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFarmerCharacter, nullptr, "UseItem", nullptr, nullptr, Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::PropPointers), sizeof(Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::FarmerCharacter_eventUseItem_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::Function_MetaDataParams), Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::PropPointers) < 2048);
	static_assert(sizeof(Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::FarmerCharacter_eventUseItem_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_AFarmerCharacter_UseItem()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AFarmerCharacter_UseItem_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_IC_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_IC;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AFarmerCharacter_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AFarmerCharacter_UseItem, "UseItem" }, // 1891982824
	};
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFarmerCharacter_Statics::NewProp_IA_EAction = { "IA_EAction", nullptr, (EPropertyFlags)0x0040000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFarmerCharacter, IA_EAction), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AFarmerCharacter_Statics::NewProp_IA_EAction_MetaData), Z_Construct_UClass_AFarmerCharacter_Statics::NewProp_IA_EAction_MetaData) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFarmerCharacter_Statics::NewProp_IC_MetaData[] = {
		{ "Category", "FarmerCharacter" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// lalalalala test\n" },
#endif
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "FarmerCharacter.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "lalalalala test" },
#endif
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFarmerCharacter_Statics::NewProp_IC = { "IC", nullptr, (EPropertyFlags)0x001000000008000d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFarmerCharacter, IC), Z_Construct_UClass_UInventoryComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AFarmerCharacter_Statics::NewProp_IC_MetaData), Z_Construct_UClass_AFarmerCharacter_Statics::NewProp_IC_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFarmerCharacter_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFarmerCharacter_Statics::NewProp_IC,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_cheng_source_repos_UE5_Farmer_Source_Farmer_FarmerCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AFarmerCharacter, AFarmerCharacter::StaticClass, TEXT("AFarmerCharacter"), &Z_Registration_Info_UClass_AFarmerCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFarmerCharacter), 2047621308U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_cheng_source_repos_UE5_Farmer_Source_Farmer_FarmerCharacter_h_1741909925(TEXT("/Script/Farmer"),
